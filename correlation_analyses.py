...
for i, params in enumerate(param_values):
    # запуск модели
    simulation_generator.parameters_generator(params, f"parameters/parameters_{i}.txt")
...
with open(OUTPUT_DIR / "analysis_result/Morris_DBC_results.txt", "w") as f:
...
with open(OUTPUT_DIR / "analysis_result/Morris_Lacunarity_results.txt", "w") as f:
